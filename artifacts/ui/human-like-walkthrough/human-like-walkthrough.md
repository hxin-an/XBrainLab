...
- `data_interpretation_apply` -> `artifacts/ui/human-like-walkthrough/07-recipe-reloaded.png`
- `data_interpretation_save_recipe` -> `artifacts/ui/human-like-walkthrough/07-recipe-reloaded.png`
...
- start: threads `1`, qt active `0`, rss `835332` KB
- before_close: threads `1`, qt active `0`, rss `1058016` KB
- after_close: threads `1`, qt active `0`, rss `1058016` KB
