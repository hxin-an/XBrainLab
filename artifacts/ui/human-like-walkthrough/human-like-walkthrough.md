...
- RSS growth: `232980` KB / limit `600000` KB
...
- start: threads `1`, qt active `0`, rss `837376` KB
- before_close: threads `1`, qt active `0`, rss `1070356` KB
- after_close: threads `1`, qt active `0`, rss `1070356` KB
