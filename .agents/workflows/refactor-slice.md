...
8. Finish the bounded subtask, then continue directly necessary, declared work in the same authorized outcome. Stop for an independent finding or material scope expansion; that next slice needs a new scope record or user request.

For presentation-only UI work record layout/visual invariants; require command shape only for state-changing workflows. Independent findings do not expand this slice.
