...
1. Identify primary audiences and the top tasks each must complete.
2. Read the current MkDocs navigation, landing page, theme overrides, and only the artifacts being
   surfaced.
3. Sketch the navigation and page hierarchy before editing layout.
4. Reuse Material primitives and existing design tokens; keep custom CSS bounded.
5. Distinguish current status, target design, guides, evidence, and historical records visually.
