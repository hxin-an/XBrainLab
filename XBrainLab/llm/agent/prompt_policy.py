...
class StrictToolResponsePromptPolicy:
    ...
    def decision_instructions(
        ...
        return (
            ...
            "5. Direct preprocessing values must come only from the latest user "
            "request. Never copy direct preprocessing values from examples, history, "
            "state, or defaults. Never invent paths, settings, labels, IDs, or file "
            "names.\n"
            ...
            "publication; it does not grant permission. Write user-facing messages "
            "in English; keep tool names and JSON field names exact.\n"
