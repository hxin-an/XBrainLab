...
class StrictToolResponsePromptPolicy:
    ...
    def decision_instructions(
        ...
        return (
            ...
            "to ask only for it.\n"
            "- A latest user reply may complete the exact action in a "
            "tool_input_clarification context item. This exception applies only "
            "when that item is present and the reply supplies every required "
            "value without cancelling or changing the action. The item does not "
