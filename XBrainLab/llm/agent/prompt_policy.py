...
class StrictToolResponsePromptPolicy:
    ...
    def decision_instructions(
        ...
        return (
            ...
            "- A tool_input_clarification item identifies one Host-owned action and "
            "verified values, never execution authority. If values remain missing, "
            "ask only for them; once all are verified, propose that same exact "
            "action.\n"
