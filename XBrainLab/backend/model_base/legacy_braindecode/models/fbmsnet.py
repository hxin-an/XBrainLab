...
from .fbcnet import _valid_layers
...
class FBMSNet(EEGModuleMixin, nn.Module):
    ...
    def forward(self, x):
        ...
        # shape: batch, out_channels_spatial, stride_factor, n_times/stride_factor
...
class _MixedConv2d(nn.Module):
    ...
    def __init__(
        ...
        for k, in_ch, out_ch in zip(
            kernels_weights, in_splits, out_splits, strict=True
        ):
