...
# ruff: noqa: E501, N803, N806, N812, RUF002, S101
# pyright: reportOperatorIssue=false, reportOptionalCall=false
...
class SSTDPN(EEGModuleMixin, nn.Module):
    ...
    * **Transformer Alternative:** Multi-scale Variance Pooling (MVP) provides a accuracy
    ...
    def __init__(
        ...
        mvp_kernel_sizes: list[int] | None = None,
...
class _MultiScaleVarPooler(nn.Module):
    ...
    def __init__(self, kernel_sizes: list[int] | None = None) -> None:
        super().__init__()
