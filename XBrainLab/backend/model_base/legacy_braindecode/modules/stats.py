...
MeanLayer: Callable[..., StatLayer] = partial(StatLayer, torch.mean)
MaxLayer: Callable[..., StatLayer] = partial(StatLayer, _max_fn)
VarLayer: Callable[..., StatLayer] = partial(StatLayer, torch.var)
StdLayer: Callable[..., StatLayer] = partial(StatLayer, torch.std)
LogVarLayer: Callable[..., StatLayer] = partial(
    StatLayer,
    torch.var,
...
LogPowerLayer: Callable[..., StatLayer] = partial(
    StatLayer,
    _power_fn,
