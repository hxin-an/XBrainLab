...
class Study:
    ...
    Attributes:
        loaded_data_list: list[:class:`XBrainLab.backend.load_data.Raw`].
            The raw data result loaded by :class:`XBrainLab.backend.load_data.RawDataLoader`.
        preprocessed_data_list: list[:class:`XBrainLab.backend.load_data.Raw`].
            The preprocessed data result generated by
                sequences of :class:`XBrainLab.backend.preprocessor.base.PreprocessBase`.
        epoch_data: :class:`XBrainLab.backend.dataset.Epochs` or None.
            The epoch data generated from list of :class:`XBrainLab.backend.load_data.Raw`.
        datasets: list[:class:`XBrainLab.backend.dataset.Dataset`].
            The datasets generated from :class:`XBrainLab.backend.dataset.DatasetGenerator`.
