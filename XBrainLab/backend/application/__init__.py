...
_EXPORT_MODULES: dict[str, str] = {
    ...
    "DiscardTrainingPreparationCommand": ".commands",
    "EvaluateCommand": ".commands",
    "SaveDatasetSplitCommand": ".commands",
    ...
    "EvaluationNumericSummary": ".evaluation_render",
    ...
    "DatasetSplitPreviewReceipt": ".dataset_split_preview",
    ...
    # typed Training recommendation contract
    "TrainingRecommendation": ".training_recommendation",
    "TrainingRecommendationContext": ".training_recommendation",
    "TrainingRecommendationField": ".training_recommendation",
    "TrainingRecommendationReason": ".training_recommendation",
    "TrainingRecommendationValues": ".training_recommendation",
    "TrainingSettingProvenance": ".training_recommendation",
