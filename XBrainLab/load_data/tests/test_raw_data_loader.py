...
from XBrainLab.load_data.raw_data_loader import load_gdf_file, load_set_file
...
class TestRawDataLoaderUnit:
    ...
    @patch('XBrainLab.load_data.raw.validate_type')
    @patch('XBrainLab.load_data.raw_data_loader.mne.io.read_raw_gdf')
    ...
    @patch('XBrainLab.load_data.raw.validate_type')
    @patch('XBrainLab.load_data.raw_data_loader.mne.io.read_raw_eeglab')
    ...
    @patch('XBrainLab.load_data.raw.validate_type')
    @patch('XBrainLab.load_data.raw_data_loader.mne.io.read_epochs_eeglab')
    @patch('XBrainLab.load_data.raw_data_loader.mne.io.read_raw_eeglab')
