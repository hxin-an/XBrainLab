...
def test_filtering_dialog_notch_only(mock_main_window, qtbot):
    ...
    from XBrainLab.ui.dashboard_panel.preprocess import FilteringDialog
...
def test_preprocess_panel_ica(mock_main_window, qtbot):
    ...
    with patch('XBrainLab.ui.dashboard_panel.preprocess.ICADialog') as MockDialog:
        instance = MockDialog.return_value
        instance.exec.return_value = True
...
def test_preprocess_panel_rereference(mock_main_window, qtbot):
    ...
    with patch('XBrainLab.ui.dashboard_panel.preprocess.RereferenceDialog') as MockDialog:
        instance = MockDialog.return_value
        instance.exec.return_value = True
