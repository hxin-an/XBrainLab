...
class Theme:
    ...
    BTN_DISABLED_BG = "#343434"
    BTN_DISABLED_BORDER = "#464646"
    BTN_DISABLED_TEXT = "#888888"

    BTN_SUCCESS_DISABLED_BG = BTN_DISABLED_BG
    BTN_SUCCESS_DISABLED_BORDER = BTN_DISABLED_BORDER

    BTN_DANGER_DISABLED_BG = "#3a2020"
    BTN_DANGER_DISABLED_BORDER = "#5a2a2a"
    BTN_DANGER_DISABLED_TEXT = "#b88a8a"

    BTN_WARNING_DISABLED_BG = BTN_DISABLED_BG
    BTN_WARNING_DISABLED_BORDER = BTN_DISABLED_BORDER
