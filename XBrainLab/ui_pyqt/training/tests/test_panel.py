...
class TestTrainingPanel:
    ...
    def test_select_model_success(self, panel):
        ...
        with patch('XBrainLab.ui_pyqt.training.panel.ModelSelectionWindow') as MockWindow:
    ...
    def test_training_setting_success(self, panel):
        ...
        with patch('XBrainLab.ui_pyqt.training.panel.TrainingSettingWindow') as MockWindow:
            instance = MockWindow.return_value
            instance.exec.return_value = True
            instance.get_result.return_value = mock_result
    ...
    def test_test_only_setting_success(self, panel):
        ...
        with patch('XBrainLab.ui_pyqt.training.panel.TestOnlySettingWindow') as MockWindow:
            instance = MockWindow.return_value
            instance.exec.return_value = True
            instance.get_result.return_value = mock_result
