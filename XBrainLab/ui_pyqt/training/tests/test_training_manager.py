...
from XBrainLab.ui_pyqt.training.training_manager import TrainingManagerWindow
...
class TestTrainingManager:
    ...
    def window(self, qtbot, mock_trainer):
        ...
        with patch('XBrainLab.ui_pyqt.training.training_manager.isinstance', return_value=True):
