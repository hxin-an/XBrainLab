...
def test_visualization_panel_init(mock_main_window, qtbot):
    ...
    with patch('XBrainLab.ui_pyqt.visualization.panel.SaliencyMapWidget', side_effect=DummyWidget), \
         patch('XBrainLab.ui_pyqt.visualization.panel.SaliencyTopographicMapWidget', side_effect=DummyWidget), \
         patch('XBrainLab.ui_pyqt.visualization.panel.SaliencySpectrogramWidget', side_effect=DummyWidget), \
         patch('XBrainLab.ui_pyqt.visualization.panel.Saliency3DPlotWidget', side_effect=DummyWidget):
...
def test_visualization_panel_refresh_data(mock_main_window, qtbot):
    ...
    with patch('XBrainLab.ui_pyqt.visualization.panel.SaliencyMapWidget', side_effect=DummyWidget) as MockMap, \
         patch('XBrainLab.ui_pyqt.visualization.panel.SaliencyTopographicMapWidget', side_effect=DummyWidget) as MockTopo, \
         patch('XBrainLab.ui_pyqt.visualization.panel.SaliencySpectrogramWidget', side_effect=DummyWidget) as MockSpec, \
         patch('XBrainLab.ui_pyqt.visualization.panel.Saliency3DPlotWidget', side_effect=DummyWidget) as Mock3D, \
         patch('XBrainLab.ui_pyqt.visualization.panel.QMessageBox.information'):
...
def test_visualization_panel_set_montage(mock_main_window, qtbot):
    ...
    # Mock Dialog
    with patch('XBrainLab.ui_pyqt.visualization.panel.PickMontageWindow') as MockDialog, \
         patch('XBrainLab.ui_pyqt.visualization.panel.QMessageBox.information') as mock_info:
...
def test_visualization_panel_set_saliency(mock_main_window, qtbot):
    ...
    with patch('XBrainLab.ui_pyqt.visualization.panel.SetSaliencyWindow') as MockDialog, \
         patch('XBrainLab.ui_pyqt.visualization.panel.QMessageBox.information') as mock_info:
