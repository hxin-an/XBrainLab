from PyQt6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QLabel, QComboBox, QCheckBox, QMessageBox
)
from PyQt6.QtCore import Qt
from matplotlib.backends.backend_qtagg import FigureCanvasQTAgg as FigureCanvas
from matplotlib.figure import Figure
from XBrainLab.visualization import VisualizerType, supported_saliency_methods
...
class SaliencyTopographicMapWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.ax.text(0.5, 0.5, "Select a plan to view Topographic Map", 
