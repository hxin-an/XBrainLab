...
- panel 內建 header：`XBrainLab Assistant`、面向使用者的 workflow 說明、backend workflow
  stage、next-step chip、Retry / Clear / Options controls；local model status 放到底部低干擾
  runtime status / tooltip / settings。
