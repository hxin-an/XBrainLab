...
| fast quality dashboard | PASS at `2026-05-30 18:10:25 UTC+08:00` on `53bed8b96623`; exact details are in local generated `artifacts/quality/latest.md` | lint、type、architecture、startup、UI baseline、UI product walkthrough、UI unit、real-data IO。 |
