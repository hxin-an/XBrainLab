...
- Data Interpretation backend command baseline、agent tool exposure 和 Dataset panel main
  import entry 已進入新心智模型，但 recipe save UI、label import、headless walkthrough、
  MCP adapter、eval cases 和 UI-observable replay 尚未完成。
