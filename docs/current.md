...
| fast quality dashboard | PASS at `2026-05-30 19:09:35 UTC+08:00` on `e30822ba05e8`; exact details are in local generated `artifacts/quality/latest.md` | lint、type、architecture、startup、UI baseline、UI product walkthrough、UI unit、real-data IO。 |
