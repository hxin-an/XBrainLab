...
artifact schema，讓 train/validation/test split 可保存、重跑、審計。真 Windows launcher
人工 click-through、真 local model 長時間 UI walkthrough、external thesis experiment runner
仍未完成，不能宣稱完整 release closure。
