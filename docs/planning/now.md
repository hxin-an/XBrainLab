...
| Current classification | Draft PR `#16` validated checkpoint；latest exact-head 已驗證 integration publication-race，Windows core test 的全域 path fault injection 也已本機收斂；新 exact-head CI 與 merge 尚未完成。 |
