...
**Branch / base:** `fix/assistant-precision-clarification-v1` from exact `main`
`2c51d7b1e6ff83475f285f0db331becd3f87f5c1`. This branch owns no Qt layout, theme, Dataset dialog,
or root `settings.json` changes.
