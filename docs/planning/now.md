...
| Done | Agent Panel product UI | loading / empty / ready / working / error、responsive composer、mode selector、suggestion prompts、inline typed confirmation 與 retry 已統一；12 列長 action card 可捲動且操作可達，無空白長值也會安全斷行；focused `446/446`、product walkthrough `7/7` 連續 3 輪、human-like walkthrough與 100% / 125% / 150% Qt subprocess gate 已通過。 |
