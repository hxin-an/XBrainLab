...
3. **UI Command Refresh Coordinator + Controller Fallback Audit**
   ...
   - `tests/architecture_compliance.py` 現在會阻擋新增
     `_create_bridge(..., self.update_panel)`，防止 observer refresh boundary 回退。
