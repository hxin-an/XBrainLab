...
- Data Interpretation 第一版主線：file / folder / BIDS-style / recipe flow 已可走
  ...
  preview / validate，不再只靠 source path 重建空 candidate。
