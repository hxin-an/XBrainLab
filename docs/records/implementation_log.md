...
2. 做 Windows Desktop 真人 click-through 或更接近真人行為的 observable walkthrough。
3. 補 interactive desktop 3D / PyVista render 驗證，或把 release boundary 寫得更明確。
4. 硬化 MCP HTTP / long-running tool-call boundary，不把 Inspector GUI baseline 擴張成 full
