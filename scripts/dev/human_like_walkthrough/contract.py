...
ASSISTANT_SCREENSHOT_NAMES: dict[str, str] = {
    ...
    "assistant_confirmation_card": "16b1-assistant-confirmation-card.png",
...
ASSISTANT_FINGERPRINT_PATHS = (
    ...
    *_ASSISTANT_HELPER_PATHS,
    ...
    ROOT / "XBrainLab/llm/agent/confirmation.py",
