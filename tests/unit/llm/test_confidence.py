...
# Fixtures
# ---------------------------------------------------------------------------
_KNOWN = frozenset({"import_eeg_data", "start_training", "set_montage"})
...
class TestEstimateConfidence:
    ...
    def test_perfect_response_near_one(self):
        text = '```json\n{"tool": "import_eeg_data", "params": {"path": "/a"}}\n```'
        cmds = [("import_eeg_data", {"path": "/a"})]
        score = estimate_confidence(text, cmds, known_tools=_KNOWN)
        assert score >= 0.85

    def test_no_fence_lowers_score(self):
        text = '{"tool": "import_eeg_data", "params": {"path": "/a"}}'
        cmds = [("import_eeg_data", {"path": "/a"})]
        score = estimate_confidence(text, cmds, known_tools=_KNOWN)
        assert score < 1.0
    ...
    def test_hedging_language_lowers_score(self):
        text = 'I think ```json\n{"tool": "import_eeg_data", "params": {"p": 1}}\n```'
        cmds = [("import_eeg_data", {"p": 1})]
    ...
    def test_multiple_commands_reduces_score(self):
        text = '```json\n[{"tool": "import_eeg_data"}, {"tool": "set_montage"}]\n```'
        single = [("import_eeg_data", {"p": 1})]
        multi = [("import_eeg_data", {"p": 1}), ("set_montage", {"m": "x"})]
    ...
    def test_empty_params_lowers_score(self):
        text = '```json\n{"tool": "import_eeg_data"}\n```'
        cmds_full = [("import_eeg_data", {"path": "/a"})]
        cmds_empty = [("import_eeg_data", {})]
    ...
    def test_score_bounded_zero_one(self):
        ...
        text = '```json\n{"tool": "import_eeg_data", "params": {"x": 1}}\n```'
        cmds = [("import_eeg_data", {"x": 1})]
        score = estimate_confidence(text, cmds, known_tools=_KNOWN)
    ...
    def test_default_known_tools_used(self):
        ...
        text = '```json\n{"tool": "import_eeg_data", "params": {"p": 1}}\n```'
        cmds = [("import_eeg_data", {"p": 1})]
        # import_eeg_data is in the default set → should get the bonus
