...
def test_dataset_panel_import_data_success(mock_main_window, mock_controller, qtbot):
    ...
    with patch(
        "XBrainLab.ui.dashboard_panel.dataset.QFileDialog.getOpenFileNames",
        ...
        with patch(
            "XBrainLab.ui.dashboard_panel.dataset.QMessageBox.information"
        ) as mock_info:
            panel.import_data()
...
def test_dataset_panel_clear_dataset(mock_main_window, mock_controller, qtbot):
    ...
    with (
        patch(
            "XBrainLab.ui.dashboard_panel.dataset.QMessageBox.question",
