...
def montage_picker_mocks():
    ...
    patcher_builtin = patch(
        "XBrainLab.ui.visualization.montage_picker.get_builtin_montages"
    )
    patcher_pos = patch(
        "XBrainLab.ui.visualization.montage_picker.get_montage_positions"
    )
    patcher_ch_pos = patch(
        "XBrainLab.ui.visualization.montage_picker.get_montage_channel_positions"
    )
...
def test_smart_match(qtbot, montage_picker_mocks):
    ...
    dialog = PickMontageWindow(
        montage_picker_mocks["parent"], montage_picker_mocks["channels"]
    )
