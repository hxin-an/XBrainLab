...
class TestTrainingSettingDefaultValues:
    ...
    def test_confirm_creates_valid_training_option(self, qtbot):
        ...
        # Use defaults and confirm - patch BaseDialog.accept to prevent dialog closing
        with patch("XBrainLab.ui.core.base_dialog.BaseDialog.accept"):
            window.accept()
    ...
    def test_training_option_epoch_is_int(self, qtbot):
        ...
        # Confirm with string input (from text fields) - patch BaseDialog to prevent close
        with patch("XBrainLab.ui.core.base_dialog.BaseDialog.accept"):
            window.accept()
