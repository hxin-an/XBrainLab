...
class TestMetadataIntegration:
    ...
    def test_full_metadata_pipeline(self, tmp_path):
        ...
        sub, sess = FilenameParser.parse_by_fixed_position(
            ...
            1,
            3,  # Subject: start 1, len 3 -> A01
            4,
            1,  # Session: start 4, len 1 -> T
        )
        ...
        # For this test, we'll just create a dummy label list and verify
        # EventLoader logic assuming we are replacing or augmenting existing events.
